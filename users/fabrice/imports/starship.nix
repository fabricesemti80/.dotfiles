...
let homeDirectory = "/home/fabrice";
in {

  # Enable and configure Starship
  # "https://github.com/tejing1/nixos-config/blob/fd443fc8706dcd5e700a05421b2eb0ad39517c7d/homeConfigurations/tejing/shell.nix" # L161-L222
  programs.starship = {
    enable = true;
    # settings = {
    #   add_newline = false;
